      ...
      <div className="container custom-container mx-auto px-4">
        <div className="flex h-16 items-center justify-between md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src={logo} alt="Fast Track Tire & Lube" className="h-24 w-auto md:h-20" />
          </Link>
          ...
          <div className="hidden items-center gap-4 md:flex">
            <a href="tel:+16406400097" className="flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground">
              <Phone className="h-4 w-4" />
              <span className="hidden xl:inline">(+1) 640-640-0097</span>
            </a>
            <Button asChild className="bg-primary hover:bg-primary/90">
              <a href="tel:+16406400097">Call Now</a>
            </Button>
          </div>
